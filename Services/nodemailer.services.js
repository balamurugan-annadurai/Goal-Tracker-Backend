...
export const mail = (senderEmail, verificationString) => {
    ...
    const resetLink = `https://trackyourgoals.netlify.app/reset-password/${verificationString}`;
...
export const verifyMail = (senderEmail, verificationString) => {
    ...
    // Generate the password reset link
    const verificationLink = `https://trackyourgoals.netlify.app/activation/${verificationString}`;
